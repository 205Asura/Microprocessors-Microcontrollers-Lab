...
void display7SEG2(int num)
{
	...
	HAL_GPIO_WritePin(GPIOA, A2_Pin, (bitmask & (1 << 6)) ? RESET : SET);
	HAL_GPIO_WritePin(GPIOA, B2_Pin, (bitmask & (1 << 5)) ? RESET : SET);
	HAL_GPIO_WritePin(GPIOA, C2_Pin, (bitmask & (1 << 4)) ? RESET : SET);
	HAL_GPIO_WritePin(GPIOA, D2_Pin, (bitmask & (1 << 3)) ? RESET : SET);
	HAL_GPIO_WritePin(GPIOA, E2_Pin, (bitmask & (1 << 2)) ? RESET : SET);
	HAL_GPIO_WritePin(GPIOA, F2_Pin, (bitmask & (1 << 1)) ? RESET : SET);
	HAL_GPIO_WritePin(GPIOA, G2_Pin, (bitmask & (1 << 0)) ? RESET : SET);
}
